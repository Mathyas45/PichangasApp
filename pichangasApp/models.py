...
class equipo_app(models.Model):
    nombre = models.CharField(max_length=128, default='')
    arquero = models.CharField(max_length=128, default='')
    defensa_1 = models.CharField(max_length=128, default='')
    defensa_2 = models.CharField(max_length=128, default='')
    volante_1 = models.CharField(max_length=128, default='')
    volante_2 = models.CharField(max_length=128, default='')
    volante_3 = models.CharField(max_length=128, default='')
    delantero_1 = models.CharField(max_length=128, default='')
    delantero_2 = models.CharField(max_length=128, default='')
